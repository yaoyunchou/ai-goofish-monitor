const zhCNExtra = {
  ...
  sellerSubscription: {
    title: '卖家订阅',
    description: '在此直接添加要监控的卖家主页，系统按定时规则采集前 100 条在售商品指标。',
    scheduleTitle: '采集调度',
    scheduleEnabled: '启用定时采集',
    scheduleHint: '默认每天采集一次；每位卖家监控前 {limit} 条在售商品。详情按批模拟访问（约 10 条/批、批间休息、切换卖家冷却），5 店约需数小时而非一口气打完。',
  ...
  shopAnalytics: {
    title: '店铺数据罗盘',
    description: '来自闲鱼卖家工作台 datacompass 的经营指标。',
    collect: '立即采集',
