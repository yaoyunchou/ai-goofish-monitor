const enUSExtra = {
  ...
  sellerSubscription: {
    ...
    trendHoverHint: 'Hover a point to read its daily values; focus the chart and use ← → to step through dates.',
    metricEmpty: 'no data',
    trendTitleWant: 'Wants trend',
    trendTitleView: 'Views trend',
