const enUSExtra = {
  ...
  collections: {
    ...
    list: {
      ...
      empty: 'No items collected yet. Go to Results and click Collect.',
      totalCount: '{count} total',
      doneCount: '{count} parsed',
      skuCount: '{count} variants',
      loadFailed: 'Failed to load collections',
      deleted: 'Collection removed',
      deleteFailed: 'Failed to remove collection',
    },
    detail: {
  ...
  sellers: {
    ...
    empty: 'No followed sellers yet. Click "Follow Seller" on a collection detail page.',
    refresh: 'Refresh',
    ...
    unfollow: 'Unfollow',
    followed: 'Following',
    sortWantCnt: 'Want Count',
    sortBrowseCnt: 'Browse Count',
    sortSoldCnt: 'Sold Count',
    sortPrice: 'Price',
