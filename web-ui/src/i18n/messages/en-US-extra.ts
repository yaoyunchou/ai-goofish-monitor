const enUSExtra = {
  ...
  sellerSubscription: {
    ...
    description: 'Add seller homepages here. Scheduled jobs scrape up to 100 on-sale items per seller.',
    ...
    followers: 'Followers',
    itemCount: 'Items',
    itemsTitle: 'Latest item metrics',
    colTitle: 'Title',
    colPrice: 'Price',
    colWant: 'Wants',
    colView: 'Views',
  ...
  shopAnalytics: {
    title: 'Shop Datacompass',
    description: 'Operating metrics from the Goofish seller workbench.',
    collect: 'Collect now',
    ...
    empty: 'No data yet. Run a shop analytics task first.',
    showPv: 'Impressions',
    ipv: 'Item views',
    vstUv: 'Visitors',
