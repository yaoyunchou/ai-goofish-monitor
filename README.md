...
- [架构文档](./docs/architecture.md) — 分层架构、模块设计、数据模型、并发与进程模型、设计决策
...
- **Web 可视化管理**: 任务管理、账号管理、卖家订阅、店铺数据罗盘、运行日志、结果浏览
- **卖家订阅**: 按用户主页批量采集，仅入库同时有「想要」和「浏览量」的商品
- **店铺数据罗盘**: 定时采集卖家工作台 datacompass（近1/7/30天）并在 Web UI 展示
